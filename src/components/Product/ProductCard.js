  ...
  return (
    <div className="bg-white overflow-hidden group transition-all duration-300 hover:shadow-2xl text-center">
      ...
      <div className="p-4 pt-0">
        ...
        <Link to={`/products/${product.id}`} className="text-sm font-semibold text-secondary uppercase h-16  block hover:text-primary transition-colors">
          {product.name}
        </Link>
        <div className="flex flex-col justify-center items-center gap-1 min-h-[56px]">
